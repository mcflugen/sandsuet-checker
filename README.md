...
To run the example, pip install `sandsuet-checker` with optional `examples` dependencies
first. This installs *pooch* with a `tqdm` progress bar.

```bash
pip install "sandsuet-checker[examples]"
